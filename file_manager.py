...
highlighted_item, path, copy_path, current_page, items_pages = use_cfg[1]
...
while True:
    ...
    key = menu.getch()    
    highlighted_item += (sf.steering(key, lower_bar, path, highlighted_item, last_index, current_page, items_pages, list_len, max_list_len) if key else sf.check_highlight(highlighted_item, first_index, last_index))
