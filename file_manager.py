...
menu_shadow, menu, max_list_len, margin = sf.screen_elements()
...
while True:
    ...
    path = sf.render_things(menu, max_name_len, show_hidden_items, highlighted_item, max_list_len, items_pages, current_page, first_index, last_index)
    key = menu.getch()
